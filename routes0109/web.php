...
*/
 ...
 Route::get('/christian-music-free',[MusicController::class, 'christianMusic'])->name('christian.music.free');
 Route::get('/christian-music-free/{id}',[MusicController::class, 'albumgetByID'])->name('album.details');
 Route::get('/paypal-success/{id}',[PaypalController::class, 'success'])->middleware('is_frontendlogin');
 Route::get('/paypal-cancel',[PaypalController::class, 'cancel'])->middleware('is_frontendlogin');
