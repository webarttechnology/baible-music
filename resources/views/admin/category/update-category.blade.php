							...
							<div class="col-12">
								<div class="card" style="style">
									...
									<span id="errmsg" style="color:red"></span>
										<form class="form-horizontal"  action="{{ url('/author/category/update') }}" method='POST' onsubmit="return valid();" autocomplete="off" >
                                        @csrf
											...
											<div class="form-group row">
												...
												<div class="col-md-4">
													<textarea type="text" class="form-control" id="details" name="details" placeholder="Category Details">{{ $category->details }}</textarea>
