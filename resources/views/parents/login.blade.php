<x-headercomponent title="Klicsports | Parents Login" />
                    ...
                    <div class="px-2 turnamentContant">
                        <div class="wrapper wrapper2">
                            <form id="login" class="card-body" tabindex="500" method="post"
                                action="{{ route('parent.login.action') }}" class="form-horizontal"
                                onsubmit="return valid();">
                                @csrf

                                <div class="rgb-white-style pb-5">
                                    <h3 class="featured-title text-center fa-2x mb-5">Parent Login</h3>
                                    <div class="pull-left">
                                    ...
                                    <p class="mb-3 text-left">Don't have account? 
                                        <a href="{{ route('parent.signup') }}" style="color:#222;">Signup</a></p>
