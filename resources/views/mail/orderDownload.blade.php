         ...
         <table style="margin-left: 5rem;width: 75%;" class="list">
              ...
              <tr>
               ...
               <tr>
                ...
                <tr>
                  <td>We will ship this product to you shortly. We contact you with delivery information</td>
                  <td></td>
              ...
              @else
                  ...
                  <td>Download</td>
                  <td>
                    <a href="{{ asset($item->product->file) }}" download>Download</a>
                  </td>
