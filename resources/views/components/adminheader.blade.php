		...
		<div id="app" class="page">
			<div class="main-wrapper">
				<nav class="navbar navbar-expand-lg main-navbar">
					...
					<h2><a class="header-brand" href="{{ url('/') }}">Scripture Songs</a></h2>
					...
					<ul class="navbar-nav navbar-right">					
						<li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg d-flex">
							 ...
							 <span><img src="{{ asset('front_style/assets/img/logos.png') }}" alt="profile-user" class="rounded-circle w-32 mr-2"></span> 
							</a>
							<div class="dropdown-menu dropdown-menu-right">
								...
								<div class="dropdown-divider"></div><a class="dropdown-item" href="{{ URL::to('author/update/pass/page') }}"><i class="mdi  mdi-logout-variant mr-2"></i> <span>Update Password</span></a>
